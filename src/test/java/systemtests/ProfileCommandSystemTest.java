...
/**
 * A system test class for the profile window, which contains interaction with other UI components.
 */
public class ProfileCommandSystemTest extends WorkoutBookSystemTest {
    ...
    public void openProfileWindow() {
        ...
        // open profile window and give it focus
        executeCommand(ProfileCommand.COMMAND_WORD);
        getMainWindowHandle().focus();

        // assert that while the profile window is open the UI updates correctly for a command execution
        ...
        // assert that the status bar too is updated correctly while the profile window is open
    ...
    @Test
    public void profile_multipleCommands_onlyOneProfileWindowOpen() {
        getMainMenu().openProfileWindowUsingMenu();
    ...
    /**
     * Asserts that the profile window is open, and closes it after checking.
     */
    ...
    /**
     * Asserts that the profile window isn't open.
     */
