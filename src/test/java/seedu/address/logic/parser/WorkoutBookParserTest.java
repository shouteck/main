...
public class WorkoutBookParserTest {
    ...
    private final WorkoutBookParser parser = new WorkoutBookParser();
    ...
    public void parseCommand_delete() throws Exception {
        ...
        assertEquals(new DeleteCommand(INDEX_FIRST_WORKOUT), command);
    }

    @Test
    public void parseCommand_edit() throws Exception {
        Workout workout = new WorkoutBuilder().build();
        EditWorkoutDescriptor descriptor = new EditWorkoutDescriptorBuilder(workout).build();
