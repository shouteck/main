...
//        assertParseFailure(parser, "1" + TYPE_DESC_BOB_WORKOUT + INVALID_TYPE_DESC, Type.MESSAGE_TYPE_CONSTRAINTS);
        ...
        assertParseFailure(parser, "1" + TAG_DESC_MORNING + TAG_DESC_NIGHT + TAG_EMPTY, Tag.MESSAGE_TAG_CONSTRAINTS);
...
//        + VALID_INSTRUCTION_AMY_WORKOUT, Name.MESSAGE_NAME_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + TYPE_DESC_BOB_WORKOUT + TAG_DESC_NIGHT
                + NAME_DESC_AMY_WORKOUT + DURATION_DESC_AMY_WORKOUT + DIFFICULTY_DESC_AMY_WORKOUT + EQUIPMENT_DESC_AMY_WORKOUT
        ...
        EditWorkoutDescriptor descriptor = new EditWorkoutDescriptorBuilder().withName(VALID_NAME_AMY_WORKOUT)
                .withType(VALID_TYPE_BOB_WORKOUT).withDuration(VALID_DURATION_AMY_WORKOUT).withDifficulty(VALID_DIFFICULTY_AMY_WORKOUT)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + DURATION_DESC_BOB_WORKOUT + DIFFICULTY_DESC_AMY_WORKOUT + EQUIPMENT_DESC_AMY_WORKOUT
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_WORKOUT;
        String userInput = targetIndex.getOneBased() + TYPE_DESC_AMY_WORKOUT + DURATION_DESC_AMY_WORKOUT + DIFFICULTY_DESC_AMY_WORKOUT
                + EQUIPMENT_DESC_AMY_WORKOUT + MUSCLE_DESC_AMY_WORKOUT + CALORIES_DESC_AMY_WORKOUT + INSTRUCTION_DESC_AMY_WORKOUT + TAG_DESC_MORNING
                + TYPE_DESC_AMY_WORKOUT + DURATION_DESC_AMY_WORKOUT + DIFFICULTY_DESC_AMY_WORKOUT + EQUIPMENT_DESC_AMY_WORKOUT
                + MUSCLE_DESC_AMY_WORKOUT + CALORIES_DESC_AMY_WORKOUT + INSTRUCTION_DESC_AMY_WORKOUT + TAG_DESC_MORNING
                + TYPE_DESC_BOB_WORKOUT + DURATION_DESC_BOB_WORKOUT + DIFFICULTY_DESC_BOB_WORKOUT + EQUIPMENT_DESC_BOB_WORKOUT
                + MUSCLE_DESC_BOB_WORKOUT + CALORIES_DESC_BOB_WORKOUT + INSTRUCTION_DESC_BOB_WORKOUT + TAG_DESC_NIGHT;

        EditWorkoutDescriptor descriptor = new EditWorkoutDescriptorBuilder().withType(VALID_TYPE_BOB_WORKOUT).withDuration(VALID_DURATION_BOB_WORKOUT)
