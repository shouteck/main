 ...
 */
public class CurrentAndTrackPanelHandle extends NodeHandle<ListView<Workout>> {
    public static final String WORKOUT_LIST_VIEW_ID = "#currentAndTrackView";

    private static final String CARD_PANE_ID = "#cardPane";

    private Optional<Workout> lastRememberedSelectedWorkoutCard;

    public CurrentAndTrackPanelHandle(ListView<Workout> workoutListPanelNode) {
