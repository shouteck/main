...
** Cons: Takes up space and the implementation would require heavy modification to the UI class.
...
After performing a boolean check to confirm which attribute have to be edited, the instance of `ProfileWindowManager` will then change the attribute. Once the attribute has been change, it will then proceed to load the new file.
