...
Since the sequence is very similar to single mode recommend, the sequence diagram of this entire process can be seen in Figure 13 and 14.
...
image::ModifyCommandSD.PNG[width="700"]
