...
.. Test case: `recommend calories/150` +
   Expected: A message saying that an invalid format is used and proposing the correct format will be shown in the status message.
...
. Opening the profile window the button kbd:[F3].
* Steps:
.. Simply press kbd:[F3].
...
* Steps:
 ...
 .. Test case: `modify username/Akshay` +
    Expected: The username should changed to `Akshay`
 .. Test case: `modify height/1.78 gender/female` +
    Expected: The height should changed to `1.78m`, BMI will be updated automatically and the gender should change to `female`.
 .. Test case: `modify calories/any difficulty/beginner` +
    Expected: The calories should changed to `any` and the difficulty should change to `beginner`.
