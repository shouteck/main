...
----
WorkoutsPredicate is then passed to updateFilteredWorkoutList() method of Model to change the entire list of workouts displayed to those that matched at least one of the workouts.
