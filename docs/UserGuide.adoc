...
WARNING: The current command will receive a warning when the indexed workout's difficulty is harder than the user's indicated difficulty, duration is higher than the user's indicated duration or calories is higher than the user's indicated calories in the profile under workout presets. +
...
Change the profile's username to apple.
* `modify username/apple height/1.82` +
Change the profile's username to apple, height to 1.82m and update the BMI accordingly.
