...
** *_HEIGHT_* should only be in the from x.xx whereby x is any integer. E.g. `1.72` and `1.88` are valid.
** *_WEIGHT_* should only be in the from xx.x or xxx.x whereby x is any integer. E.g. `88.4` and `102.9` are valid.
